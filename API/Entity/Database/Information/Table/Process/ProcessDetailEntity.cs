...
namespace API.Entity.Database.Information.Table.Process
{
    public class ProcessDetailEntity
    {
        ...
        public long ProcessAttributeId;
        public string Description;

        public ProcessDetailEntity(DataRow dataRow)
        {
            if (dataRow == null)
            {
                return;
            ...
            ProcessId = Convert.ToInt64(dataRow["ProcessId"].ToString());
            ProcessAttributeId = Convert.ToInt64(dataRow["ProcessAttributeId"].ToString());
