...
{
    public class PasswordDetailEntity
    {
        public long Id;
        ...
        public long PasswordAttributeId;
        public string Description;

        public PasswordDetailEntity(DataRow dataRow)
        {
            ...
            PasswordAttributeId = Convert.ToInt64(dataRow["PasswordAttributeId"].ToString());
